...
https://docs.dsjangoproject.com/en/1.10/topics/settings/
...
INSTALLED_APPS = [
    ...
    'tool',  # 工具
    'comment',  # 评论
    'analyze.apps.AnalyzeConfig',  # 访问记录，统计匿名状态下的点赞记录
...
MIDDLEWARE = [
    'middleware.requestRecordMiddleware.RequestRecordMiddleware',
...
EMAIL_HOST_USER = os.getenv('IZONE_EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = os.getenv('IZONE_EMAIL_HOST_PASSWORD')
EMAIL_PORT = os.getenv('IZONE_EMAIL_PORT', 587)
EMAIL_USE_TLS = True
EMAIL_FROM = os.getenv('IZONE_EMAIL_FROM', EMAIL_HOST_USER)
# EMAIL_USE_SSL = os.getenv('IZONE_EMAIL_USE_TLS', False)
DEFAULT_FROM_EMAIL = os.getenv('IZONE_DEFAULT_FROM_EMAIL', EMAIL_HOST_USER)
